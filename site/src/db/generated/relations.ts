...
import { audienceSegments, dealTemplates, travelMoments, zones, routes, candidates, scanRuns, priceLog, candidateTemplateMatches, publishedDeals, contentDrafts, verificationChecks, scanRequests } from "./schema";
